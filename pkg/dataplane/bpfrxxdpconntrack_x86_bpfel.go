...
type bpfrxXdpConntrackAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type bpfrxXdpConntrackAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type bpfrxXdpConntrackAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type bpfrxXdpConntrackAppValue struct {
	_       structs.HostLayout
	AppId   uint32
	AlgType uint8
	Pad     uint8
...
type bpfrxXdpConntrackBpfDevmapVal struct {
	_       structs.HostLayout
	Ifindex uint32
	BpfProg struct {
		_  structs.HostLayout
...
type bpfrxXdpConntrackCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type bpfrxXdpConntrackCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type bpfrxXdpConntrackDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type bpfrxXdpConntrackDnatKeyV6 struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    [16]uint8
...
type bpfrxXdpConntrackDnatValue struct {
	_          structs.HostLayout
	NewDstIp   uint32
	NewDstPort uint16
	Flags      uint8
...
type bpfrxXdpConntrackDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type bpfrxXdpConntrackFilterConfig struct {
	_         structs.HostLayout
	NumRules  uint32
	RuleStart uint32
}

type bpfrxXdpConntrackFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type bpfrxXdpConntrackFloodState struct {
	_           structs.HostLayout
	SynCount    uint64
	IcmpCount   uint64
	UdpCount    uint64
...
type bpfrxXdpConntrackFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type bpfrxXdpConntrackIfaceCounterValue struct {
	_         structs.HostLayout
	RxPackets uint64
	RxBytes   uint64
	TxPackets uint64
...
type bpfrxXdpConntrackIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type bpfrxXdpConntrackIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type bpfrxXdpConntrackIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Pad          uint16
	RoutingTable uint32
...
type bpfrxXdpConntrackLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type bpfrxXdpConntrackLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}

type bpfrxXdpConntrackNat64Config struct {
	_          structs.HostLayout
	Prefix     [3]uint32
	SnatPoolId uint8
	Pad        [3]uint8
...
type bpfrxXdpConntrackNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type bpfrxXdpConntrackNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type bpfrxXdpConntrackNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type bpfrxXdpConntrackPktMeta struct {
	_     structs.HostLayout
	SrcIp struct {
		_  structs.HostLayout
		V4 uint32
...
type bpfrxXdpConntrackPolicyRule struct {
	_           structs.HostLayout
	RuleId      uint32
	PolicySetId uint32
	Sequence    uint16
...
type bpfrxXdpConntrackPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type bpfrxXdpConntrackScanTrackKey struct {
	_      structs.HostLayout
	SrcIp  uint32
	ZoneId uint16
	Pad    uint16
...
type bpfrxXdpConntrackScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type bpfrxXdpConntrackScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type bpfrxXdpConntrackSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type bpfrxXdpConntrackSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type bpfrxXdpConntrackSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  bpfrxXdpConntrackSessionKey
	AlgType     uint8
	LogFlags    uint8
	Pad         [2]uint8
	FibIfindex  uint32
...
type bpfrxXdpConntrackSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  bpfrxXdpConntrackSessionKeyV6
	AlgType     uint8
	LogFlags    uint8
	Pad         [2]uint8
	FibIfindex  uint32
...
type bpfrxXdpConntrackSnatKey struct {
	_        structs.HostLayout
	FromZone uint16
	ToZone   uint16
	RuleIdx  uint16
...
type bpfrxXdpConntrackSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type bpfrxXdpConntrackSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type bpfrxXdpConntrackStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type bpfrxXdpConntrackStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type bpfrxXdpConntrackStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type bpfrxXdpConntrackVlanIfaceInfo struct {
	_             structs.HostLayout
...
type bpfrxXdpConntrackZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
type bpfrxXdpConntrackZonePairKey struct {
	_        structs.HostLayout
	FromZone uint16
	ToZone   uint16
}

// loadBpfrxXdpConntrack returns the embedded CollectionSpec for bpfrxXdpConntrack.
func loadBpfrxXdpConntrack() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_BpfrxXdpConntrackBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load bpfrxXdpConntrack: %w", err)
	}

	return spec, err
}

// loadBpfrxXdpConntrackObjects loads bpfrxXdpConntrack and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*bpfrxXdpConntrackObjects
//	*bpfrxXdpConntrackPrograms
//	*bpfrxXdpConntrackMaps
//
...
// bpfrxXdpConntrackSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxXdpConntrackSpecs struct {
	bpfrxXdpConntrackProgramSpecs
	bpfrxXdpConntrackMapSpecs
	bpfrxXdpConntrackVariableSpecs
}

// bpfrxXdpConntrackProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxXdpConntrackProgramSpecs struct {
	XdpConntrackProg *ebpf.ProgramSpec `ebpf:"xdp_conntrack_prog"`
}

// bpfrxXdpConntrackMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxXdpConntrackMapSpecs struct {
...
// bpfrxXdpConntrackVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxXdpConntrackVariableSpecs struct {
}

// bpfrxXdpConntrackObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxXdpConntrackObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxXdpConntrackObjects struct {
	bpfrxXdpConntrackPrograms
	bpfrxXdpConntrackMaps
	bpfrxXdpConntrackVariables
}

func (o *bpfrxXdpConntrackObjects) Close() error {
	return _BpfrxXdpConntrackClose(
		&o.bpfrxXdpConntrackPrograms,
		&o.bpfrxXdpConntrackMaps,
	)
}

// bpfrxXdpConntrackMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxXdpConntrackObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxXdpConntrackMaps struct {
...
func (m *bpfrxXdpConntrackMaps) Close() error {
	return _BpfrxXdpConntrackClose(
		m.AddressBookV4,
		m.AddressBookV6,
		m.AddressMembership,
...
// bpfrxXdpConntrackVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxXdpConntrackObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxXdpConntrackVariables struct {
}

// bpfrxXdpConntrackPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxXdpConntrackObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxXdpConntrackPrograms struct {
	XdpConntrackProg *ebpf.Program `ebpf:"xdp_conntrack_prog"`
}

func (p *bpfrxXdpConntrackPrograms) Close() error {
	return _BpfrxXdpConntrackClose(
		p.XdpConntrackProg,
	)
}
...
//
//go:embed bpfrxxdpconntrack_x86_bpfel.o

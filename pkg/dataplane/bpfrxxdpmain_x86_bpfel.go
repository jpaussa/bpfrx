...
type bpfrxXdpMainAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type bpfrxXdpMainAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type bpfrxXdpMainAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type bpfrxXdpMainCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type bpfrxXdpMainCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type bpfrxXdpMainDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type bpfrxXdpMainDnatKeyV6 struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    [16]uint8
...
type bpfrxXdpMainDnatValue struct {
	_          structs.HostLayout
	NewDstIp   uint32
	NewDstPort uint16
	Flags      uint8
...
type bpfrxXdpMainDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type bpfrxXdpMainFilterConfig struct {
	_         structs.HostLayout
	NumRules  uint32
	RuleStart uint32
}

type bpfrxXdpMainFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type bpfrxXdpMainFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type bpfrxXdpMainIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type bpfrxXdpMainIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type bpfrxXdpMainIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Pad          uint16
	RoutingTable uint32
...
type bpfrxXdpMainLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type bpfrxXdpMainLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}
...
type bpfrxXdpMainNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type bpfrxXdpMainNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type bpfrxXdpMainNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type bpfrxXdpMainNatPoolConfig struct {
	_              structs.HostLayout
	NumIps         uint16
	NumIpsV6       uint16
	PortLow        uint16
...
type bpfrxXdpMainNatPortCounter struct {
	_       structs.HostLayout
	Counter uint64
}
...
type bpfrxXdpMainPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type bpfrxXdpMainScanTrackKey struct {
	_      structs.HostLayout
	SrcIp  uint32
	ZoneId uint16
	Pad    uint16
...
type bpfrxXdpMainScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type bpfrxXdpMainScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type bpfrxXdpMainSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type bpfrxXdpMainSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type bpfrxXdpMainSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
...
type bpfrxXdpMainSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
...
type bpfrxXdpMainSnatKey struct {
	_        structs.HostLayout
	FromZone uint16
	ToZone   uint16
	RuleIdx  uint16
...
type bpfrxXdpMainSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type bpfrxXdpMainSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type bpfrxXdpMainStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type bpfrxXdpMainStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type bpfrxXdpMainStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type bpfrxXdpMainVlanIfaceInfo struct {
	_             structs.HostLayout
...
type bpfrxXdpMainZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
type bpfrxXdpMainZonePairKey struct {
	_        structs.HostLayout
	FromZone uint16
	ToZone   uint16
}

// loadBpfrxXdpMain returns the embedded CollectionSpec for bpfrxXdpMain.
func loadBpfrxXdpMain() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_BpfrxXdpMainBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load bpfrxXdpMain: %w", err)
	}

	return spec, err
}

// loadBpfrxXdpMainObjects loads bpfrxXdpMain and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*bpfrxXdpMainObjects
//	*bpfrxXdpMainPrograms
//	*bpfrxXdpMainMaps
//
...
// bpfrxXdpMainSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxXdpMainSpecs struct {
	bpfrxXdpMainProgramSpecs
	bpfrxXdpMainMapSpecs
	bpfrxXdpMainVariableSpecs
}

// bpfrxXdpMainProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxXdpMainProgramSpecs struct {
	XdpMainProg *ebpf.ProgramSpec `ebpf:"xdp_main_prog"`
}

// bpfrxXdpMainMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxXdpMainMapSpecs struct {
...
// bpfrxXdpMainVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxXdpMainVariableSpecs struct {
}

// bpfrxXdpMainObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxXdpMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxXdpMainObjects struct {
	bpfrxXdpMainPrograms
	bpfrxXdpMainMaps
	bpfrxXdpMainVariables
}

func (o *bpfrxXdpMainObjects) Close() error {
	return _BpfrxXdpMainClose(
		&o.bpfrxXdpMainPrograms,
		&o.bpfrxXdpMainMaps,
	)
}

// bpfrxXdpMainMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxXdpMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxXdpMainMaps struct {
...
func (m *bpfrxXdpMainMaps) Close() error {
	return _BpfrxXdpMainClose(
		m.AddressBookV4,
		m.AddressBookV6,
		m.AddressMembership,
...
// bpfrxXdpMainVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxXdpMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxXdpMainVariables struct {
}

// bpfrxXdpMainPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxXdpMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxXdpMainPrograms struct {
	XdpMainProg *ebpf.Program `ebpf:"xdp_main_prog"`
}

func (p *bpfrxXdpMainPrograms) Close() error {
	return _BpfrxXdpMainClose(
		p.XdpMainProg,
	)
}
...
//
//go:embed bpfrxxdpmain_x86_bpfel.o

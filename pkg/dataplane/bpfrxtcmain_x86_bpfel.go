...
type bpfrxTcMainAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type bpfrxTcMainAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type bpfrxTcMainAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type bpfrxTcMainAppValue struct {
	_       structs.HostLayout
	AppId   uint32
	AlgType uint8
	Pad     uint8
...
type bpfrxTcMainBpfDevmapVal struct {
	_       structs.HostLayout
	Ifindex uint32
	BpfProg struct {
		_  structs.HostLayout
...
type bpfrxTcMainCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type bpfrxTcMainCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type bpfrxTcMainDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type bpfrxTcMainDnatKeyV6 struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    [16]uint8
...
type bpfrxTcMainDnatValue struct {
	_          structs.HostLayout
	NewDstIp   uint32
	NewDstPort uint16
	Flags      uint8
...
type bpfrxTcMainDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type bpfrxTcMainFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type bpfrxTcMainFloodState struct {
	_           structs.HostLayout
	SynCount    uint64
	IcmpCount   uint64
	UdpCount    uint64
...
type bpfrxTcMainFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type bpfrxTcMainIfaceCounterValue struct {
	_         structs.HostLayout
	RxPackets uint64
	RxBytes   uint64
	TxPackets uint64
...
type bpfrxTcMainIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type bpfrxTcMainIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type bpfrxTcMainIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Pad          uint16
	RoutingTable uint32
...
type bpfrxTcMainLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type bpfrxTcMainLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}

type bpfrxTcMainNat64Config struct {
	_          structs.HostLayout
	Prefix     [3]uint32
	SnatPoolId uint8
	Pad        [3]uint8
...
type bpfrxTcMainNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type bpfrxTcMainNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type bpfrxTcMainNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type bpfrxTcMainPktMeta struct {
	_     structs.HostLayout
	SrcIp struct {
		_  structs.HostLayout
		V4 uint32
...
type bpfrxTcMainPolicyRule struct {
	_           structs.HostLayout
	RuleId      uint32
	PolicySetId uint32
	Sequence    uint16
...
type bpfrxTcMainPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type bpfrxTcMainScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type bpfrxTcMainScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type bpfrxTcMainSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type bpfrxTcMainSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type bpfrxTcMainSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  bpfrxTcMainSessionKey
	AlgType     uint8
	LogFlags    uint8
	Pad         [2]uint8
	FibIfindex  uint32
...
type bpfrxTcMainSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  bpfrxTcMainSessionKeyV6
	AlgType     uint8
	LogFlags    uint8
	Pad         [2]uint8
	FibIfindex  uint32
...
type bpfrxTcMainSnatKey struct {
	_        structs.HostLayout
	FromZone uint16
	ToZone   uint16
	RuleIdx  uint16
...
type bpfrxTcMainSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type bpfrxTcMainSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type bpfrxTcMainStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type bpfrxTcMainStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type bpfrxTcMainStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type bpfrxTcMainVlanIfaceInfo struct {
	_             structs.HostLayout
...
type bpfrxTcMainZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
func loadBpfrxTcMain() (*ebpf.CollectionSpec, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("can't load bpfrxTcMain: %w", err)
	}

	return spec, err
}

// loadBpfrxTcMainObjects loads bpfrxTcMain and converts it into a struct.
//
...
func loadBpfrxTcMainObjects(obj interface{}, opts *ebpf.CollectionOptions) error {
	spec, err := loadBpfrxTcMain()
	if err != nil {
		return err
	}
...
// bpfrxTcMainSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxTcMainSpecs struct {
	bpfrxTcMainProgramSpecs
	bpfrxTcMainMapSpecs
	bpfrxTcMainVariableSpecs
}

// bpfrxTcMainProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxTcMainProgramSpecs struct {
	TcMainProg *ebpf.ProgramSpec `ebpf:"tc_main_prog"`
}

// bpfrxTcMainMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxTcMainMapSpecs struct {
...
// bpfrxTcMainVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxTcMainVariableSpecs struct {
}

// bpfrxTcMainObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxTcMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxTcMainObjects struct {
	bpfrxTcMainPrograms
	bpfrxTcMainMaps
	bpfrxTcMainVariables
}

func (o *bpfrxTcMainObjects) Close() error {
	return _BpfrxTcMainClose(
		&o.bpfrxTcMainPrograms,
		&o.bpfrxTcMainMaps,
	)
}

// bpfrxTcMainMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxTcMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxTcMainMaps struct {
...
func (m *bpfrxTcMainMaps) Close() error {
	return _BpfrxTcMainClose(
		m.AddressBookV4,
		m.AddressBookV6,
		m.AddressMembership,
...
// bpfrxTcMainVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxTcMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxTcMainVariables struct {
}

// bpfrxTcMainPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxTcMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxTcMainPrograms struct {
	TcMainProg *ebpf.Program `ebpf:"tc_main_prog"`
}

func (p *bpfrxTcMainPrograms) Close() error {
	return _BpfrxTcMainClose(
		p.TcMainProg,
	)
}

func _BpfrxTcMainClose(closers ...io.Closer) error {
...
//
//go:embed bpfrxtcmain_x86_bpfel.o
var _BpfrxTcMainBytes []byte

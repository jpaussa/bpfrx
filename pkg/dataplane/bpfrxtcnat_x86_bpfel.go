...
type bpfrxTcNatAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type bpfrxTcNatAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type bpfrxTcNatAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type bpfrxTcNatAppValue struct {
	_       structs.HostLayout
	AppId   uint32
	AlgType uint8
	Pad     uint8
...
type bpfrxTcNatBpfDevmapVal struct {
	_       structs.HostLayout
	Ifindex uint32
	BpfProg struct {
		_  structs.HostLayout
...
type bpfrxTcNatCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type bpfrxTcNatCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type bpfrxTcNatDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type bpfrxTcNatDnatKeyV6 struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    [16]uint8
...
type bpfrxTcNatDnatValue struct {
	_          structs.HostLayout
	NewDstIp   uint32
	NewDstPort uint16
	Flags      uint8
...
type bpfrxTcNatDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type bpfrxTcNatFilterConfig struct {
	_         structs.HostLayout
	NumRules  uint32
	RuleStart uint32
}

type bpfrxTcNatFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type bpfrxTcNatFloodState struct {
	_           structs.HostLayout
	SynCount    uint64
	IcmpCount   uint64
	UdpCount    uint64
...
type bpfrxTcNatFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type bpfrxTcNatIfaceCounterValue struct {
	_         structs.HostLayout
	RxPackets uint64
	RxBytes   uint64
	TxPackets uint64
...
type bpfrxTcNatIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type bpfrxTcNatIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type bpfrxTcNatIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Pad          uint16
	RoutingTable uint32
...
type bpfrxTcNatLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type bpfrxTcNatLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}

type bpfrxTcNatNat64Config struct {
	_          structs.HostLayout
	Prefix     [3]uint32
	SnatPoolId uint8
	Pad        [3]uint8
...
type bpfrxTcNatNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type bpfrxTcNatNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type bpfrxTcNatNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type bpfrxTcNatPolicyRule struct {
	_           structs.HostLayout
	RuleId      uint32
	PolicySetId uint32
	Sequence    uint16
...
type bpfrxTcNatPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type bpfrxTcNatScanTrackKey struct {
	_      structs.HostLayout
	SrcIp  uint32
	ZoneId uint16
	Pad    uint16
...
type bpfrxTcNatScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type bpfrxTcNatScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type bpfrxTcNatSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type bpfrxTcNatSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type bpfrxTcNatSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  bpfrxTcNatSessionKey
	AlgType     uint8
	LogFlags    uint8
	Pad         [2]uint8
	FibIfindex  uint32
...
type bpfrxTcNatSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  bpfrxTcNatSessionKeyV6
	AlgType     uint8
	LogFlags    uint8
	Pad         [2]uint8
	FibIfindex  uint32
...
type bpfrxTcNatSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type bpfrxTcNatSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type bpfrxTcNatStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type bpfrxTcNatStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type bpfrxTcNatStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type bpfrxTcNatVlanIfaceInfo struct {
	_             structs.HostLayout
...
type bpfrxTcNatZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
type bpfrxTcNatZonePairKey struct {
	_        structs.HostLayout
	FromZone uint16
	ToZone   uint16
}

// loadBpfrxTcNat returns the embedded CollectionSpec for bpfrxTcNat.
func loadBpfrxTcNat() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_BpfrxTcNatBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load bpfrxTcNat: %w", err)
	}

	return spec, err
}

// loadBpfrxTcNatObjects loads bpfrxTcNat and converts it into a struct.
//
...
// bpfrxTcNatSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxTcNatSpecs struct {
	bpfrxTcNatProgramSpecs
	bpfrxTcNatMapSpecs
	bpfrxTcNatVariableSpecs
}

// bpfrxTcNatProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxTcNatProgramSpecs struct {
	TcNatProg *ebpf.ProgramSpec `ebpf:"tc_nat_prog"`
}

// bpfrxTcNatMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxTcNatMapSpecs struct {
...
// bpfrxTcNatVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfrxTcNatVariableSpecs struct {
}

// bpfrxTcNatObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxTcNatObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxTcNatObjects struct {
	bpfrxTcNatPrograms
	bpfrxTcNatMaps
	bpfrxTcNatVariables
}

func (o *bpfrxTcNatObjects) Close() error {
	return _BpfrxTcNatClose(
		&o.bpfrxTcNatPrograms,
		&o.bpfrxTcNatMaps,
	)
}

// bpfrxTcNatMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxTcNatObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxTcNatMaps struct {
...
func (m *bpfrxTcNatMaps) Close() error {
	return _BpfrxTcNatClose(
		m.AddressBookV4,
		m.AddressBookV6,
		m.AddressMembership,
...
// bpfrxTcNatVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxTcNatObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxTcNatVariables struct {
}

// bpfrxTcNatPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to loadBpfrxTcNatObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfrxTcNatPrograms struct {
	TcNatProg *ebpf.Program `ebpf:"tc_nat_prog"`
}

func (p *bpfrxTcNatPrograms) Close() error {
	return _BpfrxTcNatClose(
		p.TcNatProg,
	)
}
...
//
//go:embed bpfrxtcnat_x86_bpfel.o
